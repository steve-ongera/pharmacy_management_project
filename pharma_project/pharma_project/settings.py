"""
pharma_project/settings.py  — relevant sections
Full settings file; add your DB credentials and secret key.
"""
...
SECRET_KEY = 'django-insecure-@p6!0r9zgf4@z)qt@7-=!p@of5g+$c1!4u6%n#yfco!qi49qtq'
...
# ─── M-Pesa (Daraja) ─────────────────────────────────────────────────────────
# Set MPESA_DEV_MODE=False in production and fill in Daraja credentials
MPESA_DEV_MODE = os.environ.get('MPESA_DEV_MODE', 'True') == 'True'
